...
{               ?>
                                            ...
                                            <td><?php echo (!empty($row->FullName)) ? htmlentities($row->FullName) : "NA"; ?></td>
                                            <td><?php echo (!empty($row->MobileNumber)) ? htmlentities($row->FullName) : "NA"; ?></td>
                                            <td><?php echo (!empty($row->BloodGroup)) ? htmlentities($row->FullName) : "NA"; ?></td>
